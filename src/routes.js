...
//Stores
const Stores = React.lazy(() => import('./app/modules/Stores/List'));
const StoresAdd = React.lazy(() => import('./app/modules/Stores/Add'));
const StoresEdit = React.lazy(() => import('./app/modules/Stores/Edit'));
...
const routes = [
    ...
    { path: '/stores/add', exact: true, name: 'Add', component: StoresAdd },
    { path: '/stores/edit/:id', exact: true, name: 'Edit', component: StoresEdit },
